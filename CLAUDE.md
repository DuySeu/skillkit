...
The planning-style skills share a pattern worth reusing when writing a new one: a HARD-GATE against writing code before an approved design, a mandatory task checklist, and a dot-graph process flow.
