...
# Web stacks only. The native/desktop stacks that shipped with the upstream
# database (SwiftUI, React Native, Flutter, Jetpack Compose, JavaFX, WPF,
# WinUI, Avalonia, Uno, UWP) are deliberately absent: this skill's preview
# harness is an HTML file and its verification gate is a CSS contrast parser,
# so a native branch would have neither a preview nor a passing gate.
STACK_CONFIG = {
